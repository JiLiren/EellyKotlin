...
public class RefreshLayout extends ViewGroup implements IRefreshLayout, NestedScrollingParent, NestedScrollingChild {
     ...
     * 下拉头部视图
     */
    protected IRefreshHeader mRefreshHeader;
    /**
     * 上拉底部视图
     */
    protected IRefreshFooter mRefreshFooter;
    /**
     * 显示内容视图
     */
    ...
    protected void onFinishInflate() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (view instanceof IRefreshHeader && mRefreshHeader == null) {
                mRefreshHeader = ((IRefreshHeader) view);
            } else if (view instanceof IRefreshFooter && mRefreshFooter == null) {
                mEnableLoadmore = mEnableLoadmore || !mManualLoadMore;
                mRefreshFooter = ((IRefreshFooter) view);
    ...
    protected void onAttachedToWindow() {
        ...
        if (mRefreshListener == null) {
            mRefreshListener = new OnRefreshListener() {
                @Override
                public void onRefresh(IRefreshLayout layout) {
        ...
        if (mLoadMoreListener == null) {
            mLoadMoreListener = new OnLoadMoreListener() {
                @Override
                public void onLoadMore(IRefreshLayout layout) {
    ...
    protected void setStateDirectLoding() {
        if (mState != RefreshState.Loading) {
            ...
            if (mRefreshFooter != null) {
                mRefreshFooter.onStartAnimator(RefreshLayout.this, mFooterHeight, mFooterExtendHeight);
            }
            if (mLoadMoreListener != null) {
                mLoadMoreListener.onLoadMore(RefreshLayout.this);
            }
            if (mOnMultiPurposeListener != null) {
                mOnMultiPurposeListener.onLoadMore(RefreshLayout.this);
    ...
    protected void setStateRefreshing() {
        AnimatorListenerAdapter listener = new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (mRefreshHeader != null) {
                    mRefreshHeader.onStartAnimator(RefreshLayout.this, mHeaderHeight, mHeaderExtendHeight);
                }
                if (mOnMultiPurposeListener != null) {
    ...
    protected void moveSpinnerInfinitely(float spinner) {
        if (mState == RefreshState.TwoLevel && spinner > 0) {
            ...
            if (spinner < mHeaderHeight) {
                ...
                final double y = Math.min(M * (1 - Math.pow(100, -x / H)), x);
                // 公式 y = M(1-100^(-x/H))
...
//        }
    ...
    @Override
    public IRefreshLayout setFooterHeight(float heightDp) {
        return setFooterHeightPx(DensityUtil.dp2px(heightDp));
    }

    @Override
    public IRefreshLayout setFooterHeightPx(int heightPx) {
    ...
    @Override
    public IRefreshLayout setHeaderHeight(float heightDp) {
        return setHeaderHeightPx(DensityUtil.dp2px(heightDp));
    }

    @Override
    public IRefreshLayout setHeaderHeightPx(int heightPx) {
    ...
    @Override
    public IRefreshLayout setDragRate(float rate) {
        this.mDragRate = rate;
        return this;
    }
     ...
     */
    @Override
    public IRefreshLayout setHeaderMaxDragRate(float rate) {
     ...
     */
    @Override
    public IRefreshLayout setFooterMaxDragRate(float rate) {
     ...
     */
    @Override
    public IRefreshLayout setHeaderTriggerRate(float rate) {
     ...
     */
    @Override
    public IRefreshLayout setFooterTriggerRate(float rate) {
     ...
     */
    @Override
    public IRefreshLayout setReboundInterpolator(Interpolator interpolator) {
     ...
     */
    @Override
    public IRefreshLayout setReboundDuration(int duration) {
     ...
     */
    @Override
    public IRefreshLayout setEnableHeaderTranslationContent(boolean enable) {
     ...
     */
    @Override
    public IRefreshLayout setEnableFooterTranslationContent(boolean enable) {
     ...
     */
    @Override
    public IRefreshLayout setDisableContentWhenRefresh(boolean disable) {
     ...
     */
    @Override
    public IRefreshLayout setDisableContentWhenLoading(boolean disable) {
     ...
     */
    @Override
    public IRefreshLayout setEnableAutoLoadMore(boolean enable) {
     ...
     */
    @Override
    public IRefreshLayout setEnableOverScrollBounce(boolean enable) {
     ...
     */
    @Override
    public IRefreshLayout setEnablePureScrollMode(boolean enable) {
     ...
     */
    @Override
    public IRefreshLayout setEnableScrollContentWhenLoaded(boolean enable) {
     ...
     */
    @Override
    public IRefreshLayout setEnableScrollContentWhenRefreshed(boolean enable) {
     ...
     */
    @Override
    public IRefreshLayout setEnableLoadMoreWhenContentNotFull(boolean enable) {
     ...
     */
    @Override
    public IRefreshLayout setEnableOverScrollDrag(boolean enable) {
     ...
     */
    @Override
    public IRefreshLayout setEnableFooterFollowWhenLoadFinished(boolean enable) {
     ...
     */
    @Override
    public IRefreshLayout setRefreshHeader(IRefreshHeader header) {
     ...
     */
    @Override
    public IRefreshLayout setRefreshHeader(IRefreshHeader header, int width, int height) {
        if (header != null) {
            if (mRefreshHeader != null) {
     ...
     */
    @Override
    public IRefreshLayout setRefreshFooter(IRefreshFooter footer) {
     ...
     */
    @Override
    public IRefreshLayout setRefreshFooter(IRefreshFooter footer, int width, int height) {
        if (footer != null) {
            if (mRefreshFooter != null) {
     ...
     */
    @Override
    public IRefreshLayout setRefreshContent(View content, int width, int height) {
        if (content != null) {
            if (mRefreshContent != null) {
     ...
     */
    @Override
    public IRefreshLayout setOnRefreshListener(OnRefreshListener listener) {
     ...
     */
    @Override
    public IRefreshLayout setOnLoadMoreListener(OnLoadMoreListener listener) {
     ...
     */
    @Override
    public IRefreshLayout setOnRefreshLoadMoreListener(OnRefreshLoadMoreListener listener) {
        this.mRefreshListener = listener;
        this.mLoadMoreListener = listener;
        this.mEnableLoadmore = mEnableLoadmore || (!mManualLoadMore && listener != null);
        return this;
     ...
     */
    @Override
    public IRefreshLayout setOnMultiPurposeListener(OnMultiPurposeListener listener) {
     ...
     */
    @Override
    public IRefreshLayout setPrimaryColorsId(@ColorRes int... primaryColorId) {
     ...
     */
    @Override
    public IRefreshLayout setPrimaryColors(int... colors) {
        if (mRefreshHeader != null) {
     ...
     */
    @Override
    public IRefreshLayout setScrollBoundaryDecider(ScrollBoundaryDecider boundary) {
     ...
     */
    @Override
    public IRefreshLayout finishRefresh(boolean success) {
        long passTime = System.currentTimeMillis() - mLastRefreshingTime;
        //保证加载动画有1000毫秒的时间
     ...
     */
    @Override
    public IRefreshLayout finishRefresh(int delayed, final boolean success) {
     ...
     */
    @Override
    public IRefreshLayout finishLoadMore(boolean success) {
        long passTime = System.currentTimeMillis() - mLastLoadingTime;
     ...
     */
    @Override
    public IRefreshLayout finishLoadMore(int delayed, final boolean success) {
     ...
     */
    @Override
    public IRefreshLayout finishLoadMore(int delayed, final boolean success, final boolean noMoreData) {
        postDelayed(new Runnable() {
            @Override
            public void run() {
                if (mState == RefreshState.Loading) {
     ...
     */
    @Override
    public IRefreshLayout resetNoMoreData() {
    ...
    public static class RefreshKernelImpl implements IRefreshKernel {

        RefreshLayout layout;

        public RefreshKernelImpl(RefreshLayout layout) {
            this.layout = layout;
        }
        ...
        @Override
        public IRefreshKernel setState(@NonNull RefreshState state) {
            switch (state) {
                case None:
                    layout.resetStatus();
                    break;
        ...
        @Override
        public IRefreshKernel moveSpinner(int spinner, boolean isAnimator) {
            layout.moveSpinner(spinner, isAnimator);
            return this;
        }

        @Override
        public IRefreshKernel animSpinner(int endSpinner) {
        ...
        @Override
        public IRefreshKernel requestDrawBackgoundForHeader(int backgroundColor) {
        ...
        @Override
        public IRefreshKernel requestDrawBackgoundForFooter(int backgroundColor) {
            if (layout.mPaint == null && backgroundColor != 0) {
                layout.mPaint = new Paint();
            }
        ...
        @Override
        public IRefreshKernel requestHeaderNeedTouchEventWhenRefreshing(boolean request) {
            layout.mHeaderNeedTouchEventWhenRefreshing = request;
            return this;
        }
        @Override
        public IRefreshKernel requestFooterNeedTouchEventWhenLoading(boolean request) {
            layout.mFooterNeedTouchEventWhenLoading = request;
            return this;
        }
        @Override
        public IRefreshKernel requestDefaultHeaderTranslationContent(boolean translation) {
        ...
        @Override
        public IRefreshKernel requestRemeasureHeightForHeader() {
        ...
        @Override
        public IRefreshKernel requestRemeasureHeightForFooter() {
