...
public class TaurusHeader extends View implements IRefreshHeader/*, SizeDefinition*/ {
    ...
    //1.55f;
    private static final float SIDE_CLOUDS_FINAL_SCALE = 1f;

    //0.8f;
    private static final float CENTER_CLOUDS_INITIAL_SCALE = 0.8f;
    //1.30f;
    private static final float CENTER_CLOUDS_FINAL_SCALE = 1f;
    ...
    @Override
    public void onStateChanged(IRefreshLayout IRefreshLayout, RefreshState oldState, RefreshState newState) {
    }
...
//    }
    ...
    private void setupPathDrawable() {
        ...
        mAirplane.setBounds(0, 0, DensityUtil.dip2px(getContext(),65),
...
//        mCloudCenter.parserColors(0xfffdfdfd,0xffe8f3fd,0xffc7dcf1);
        ...
        mCloudCenter.setBounds(0, 0, DensityUtil.dip2px(getContext(),260),
